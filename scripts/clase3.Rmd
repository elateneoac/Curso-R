...
glimpse(df_sin_outliers)


```
#faltaría agregar plot no
...
Con los mismos objetivon puede emplearse [`pivot_longer()`](https://tidyr.tidyverse.org/reference/pivot_longer.html) y [`pivot_wider()`](https://tidyr.tidyverse.org/reference/pivot_wider.html). Pueden indagar ambas funciones para ver a cuál se asemeja más cada una. 


## YAPA

Para obtener resúmenes estadísticos, pueden probar con la función `skim()` del paquete Skimr o con `Desc()` del paquete DesTools: 
